...
imports:
	$(PYTHON) -c "import atlas, atlas.functional, atlas.ply, atlas.model, atlas.config, atlas.run, atlas.eval, atlas.imageio, atlas.bench, atlas.reference, atlas.data, atlas.tools.inspect_capture"
